const translations = {
  ru: {
    ...
    'projects.p6Status': 'Live', 'projects.p6Link': 'Открыть сайт', 'projects.p6Meta1': 'Landing Page',
    'projects.p6Title': 'Лендинг выставки голограмм', 'projects.p6Text': 'Промо-лендинг выставки голографических портретов с интерактивной 3D-анимацией портретов от движения мыши и scroll-эффектами.',
    'projects.p6F1': '3D-вращение портретов от курсора (custom JS)', 'projects.p6F2': 'Scroll-scrubbing анимации', 'projects.p6F3': 'Функции Elementor Pro на бесплатной версии', 'projects.p6F4': 'Форма заявки + адаптив',
    'projects.p6Price': 'По запросу', 'projects.p6PriceLabel': 'коммерческий проект',
  ...
  en: {
    ...
    'projects.p6Status': 'Live', 'projects.p6Link': 'Open site', 'projects.p6Meta1': 'Landing Page',
    'projects.p6Title': 'Hologram exhibition landing', 'projects.p6Text': 'Promo landing for a holographic-portrait exhibition with interactive 3D portrait rotation on mouse move and scroll effects.',
    'projects.p6F1': '3D portrait rotation on cursor move (custom JS)', 'projects.p6F2': 'Scroll-scrubbing animations', 'projects.p6F3': 'Elementor Pro features on the free version', 'projects.p6F4': 'Lead form + responsive',
    'projects.p6Price': 'On request', 'projects.p6PriceLabel': 'commercial project',
    ...
    'gamedev.cta': 'Discuss',
    'projects.p4Status': 'Live · Bot online',
    ...
    'footer.contactTitle': 'Contact', 'footer.channel': 'Personal channel · @red_vent', 'footer.copy': '© 2025 NOVACODE.', 'footer.made': 'Made with ❤ by NOVACODE',
