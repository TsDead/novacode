const translations = {
  ru: {
    ...
    'nav.reviews': 'Отзывы', 'nav.contact': 'Контакты', 'nav.cta': 'Связаться', 'nav.gamedev': 'Gamedev',
    ...
    'reviews.title': 'Что говорят <span class="text-accent">клиенты</span>', 'reviews.lead': 'Обратная связь по реальным проектам',
    'reviews.r1Text': '«Записали бота под нашу студию примерно за неделю. Клиенты теперь пишут прямо в Telegram, администратор не висит на телефоне. Пару правок просил — поправил быстро.»', 'reviews.r1Name': 'Владелец барбершопа', 'reviews.r1City': 'Рязань',
    'reviews.r2Text': '«Генератор карточек снял рутину по Ozon — описания и характеристики больше не пишу вручную. С первого раза не идеально попал в мои категории, но после правок стало то, что нужно.»', 'reviews.r2Name': 'Продавец на маркетплейсах', 'reviews.r2City': 'СПб',
    'reviews.r3Text': '«Заказывал лендинг. Сдал в срок, на правки реагировал спокойно. Вёрстка живая, на телефоне открывается нормально, заявки приходят.»', 'reviews.r3Name': 'Частный мастер', 'reviews.r3City': 'Москва',
  ...
  en: {
    ...
    'nav.reviews': 'Reviews', 'nav.contact': 'Contact', 'nav.cta': 'Get in touch', 'nav.gamedev': 'Gamedev',
    ...
    'reviews.title': 'What <span class="text-accent">clients</span> say', 'reviews.lead': 'Feedback from real projects',
    'reviews.r1Text': '"Got a bot built for our studio in about a week. Clients now message right in Telegram, the admin isn\'t stuck on the phone. Asked for a couple of tweaks — fixed quickly."', 'reviews.r1Name': 'Barbershop owner', 'reviews.r1City': 'Ryazan',
    'reviews.r2Text': '"The card generator took the routine off my Ozon work — I no longer write descriptions and specs by hand. Not a perfect fit for my categories on the first try, but after edits it was exactly what I needed."', 'reviews.r2Name': 'Marketplace seller', 'reviews.r2City': 'SPb',
    'reviews.r3Text': '"Ordered a landing page. Delivered on time, handled edits calmly. Layout feels alive, opens fine on mobile, leads come through."', 'reviews.r3Name': 'Private specialist', 'reviews.r3City': 'Moscow',
...
function applyTranslations(lang) {
  ...
  document.title = lang === 'en'
    ? 'NOVACODE | Dev — Telegram bots, landings, Unity games'
    : 'NOVACODE | Разработка — Telegram-боты, лендинги, игры на Unity';
